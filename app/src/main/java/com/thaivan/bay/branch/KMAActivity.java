...
//    private String type;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Tool.setTitle("KMAActivity onCreate");
    ...
    void setCustomToolbar() {
        Tool.setTitle("KMAActivity setCustomToolbar");
    ...
    public void privacy(View view) {
        Tool.setTitle("KMAActivity privacy");

        dialogPrivacy.show();
    }

    public void scan(View view) {
        Tool.setTitle("KMAActivity scan");
    ...
    void dialogPrivacyNotice() {
        Tool.setTitle("KMAActivity dialogPrivacyNotice");
    ...
    public void back_menu(View view) {
        Tool.setTitle("KMAActivity back_menu");
    ...
    public void onBackPressed() {
        Tool.setTitle("KMAActivity onBackPressed");
