...
public class ScanQrActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Tool.setTitle("ScanQrActivity onCreate");
    ...
    protected void onResume(){
        Tool.setTitle("ScanQrActivity onResume");
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        Tool.setTitle("ScanQrActivity onActivityResult");
        ...
        if (result != null) {
            if( resultCode == 3){
                Tool.setTitle("ScanQrActivity resultCode == 3");
                ...
                Tool.setTitle("ScanQrActivity resultCode == 4");
                ...
                Tool.setTitle("ScanQrActivity resultCode == 5");
                ...
                if (result.getContents() == null) {
                    Tool.setTitle("ScanQrActivity resultCode == null");
                    ...
                    Tool.setTitle("ScanQrActivity resultCode == else");
    ...
    private void customDialogLoading() {
        Tool.setTitle("ScanQrActivity customDialogLoading");
